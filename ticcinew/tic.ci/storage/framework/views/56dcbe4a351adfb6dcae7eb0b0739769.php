...
<?php $component->withAttributes([]); ?>
                    <?php if($inherit = Arr::get($theme, 'inherit')): ?>
                    ...
                    <div class="img-responsive img-responsive-4x3 card-img-top border-bottom" style="background-image: url('<?php echo e(Theme::getThemeScreenshot($key)); ?>')"></div>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <h4 class="card-title text-truncate mb-2" title="<?php echo e($theme['name']); ?>">
                            <?php echo e($theme['name']); ?>

                        </h4>
                        <?php if(! empty($theme['description'])): ?>
                            <p class="text-secondary text-truncate" title="<?php echo e($theme['description']); ?>">
                        ...
                        <div class="row g-1 g-lg-0">
                            <?php if(! empty($theme['author'])): ?>
                                <div class="col-12 col-lg">
                                    <?php echo e(trans('packages/theme::theme.author')); ?>:
                                    <?php if(! empty($theme['url'])): ?>
                                        <a href="<?php echo e($theme['url']); ?>" target="_blank" class="fw-bold" rel="nofollow,noindex"><?php echo e($theme['author']); ?></a>
                                    <?php else: ?>
                                        <strong><?php echo e($theme['author']); ?></strong>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <?php if(! empty($theme['version'])): ?>
                                <div class="col-12 col-lg-auto">
                                    <?php echo e(trans('packages/theme::theme.version')); ?>:
                                    <strong><?php echo e($theme['version']); ?></strong>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','color' => 'info','disabled' => true,'icon' => 'ti ti-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'info','disabled' => true,'icon' => 'ti ti-check']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'primary','icon' => 'ti ti-check','class' => 'btn-trigger-active-theme','data-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('theme.active', ['theme' => $key])),'data-theme' => ''.e($key).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if(Auth::guard()->user()->hasPermission('theme.remove')): ?>
                                    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','icon' => 'ti ti-trash','class' => 'btn-trigger-remove-theme','dataUrl' => route('theme.remove', ['theme' => $key]),'dataTheme' => ''.e($key).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','icon' => 'ti ti-trash','class' => 'btn-trigger-remove-theme','data-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('theme.remove', ['theme' => $key])),'data-theme' => ''.e($key).'']); ?>
                                        <?php echo e(trans('packages/theme::theme.remove')); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dcidev/CascadeProjects/tic.ci/platform/packages/theme/resources/views/list.blade.php ENDPATH**/ ?>