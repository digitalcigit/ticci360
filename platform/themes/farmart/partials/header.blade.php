                                ...
                                <ul>
                                    ...
                                    @if (is_plugin_active('ecommerce'))
                                        ...
                                        @if (auth('customer')->check())
                                            <li>
                                                <a href="{{ route('customer.overview') }}">{{ __('My Account') }} </a> <span class="d-inline-block ms-1"><a href="{{ route('customer.logout') }}" class="color-primary">{{ __('Logout') }}</a></span>
                                            </li>
                                        @else
                            ...
                            @if (theme_option('logo'))
                                <div class="logo">
                                    <a href="{{ route('public.index') }}">
                                        <img height="50px" src="{{ RvMedia::getImageUrl(theme_option('logo')) }}" alt="{{ theme_option('site_title') }}" />
                                    </a>
                                </div>
                            @endif
                        </div>
            ...
            <div class="header-mobile header-js-handler" data-sticky="{{ theme_option('sticky_header_mobile_enabled', 'yes') == 'yes' ? 'true' : 'false' }}">
                ...
                <div class="header-items-mobile header-items-mobile--center">
                    @if (theme_option('logo'))
                        <div class="logo">
                            <a href="{{ route('public.index') }}">
                                <img height="30px" src="{{ RvMedia::getImageUrl(theme_option('logo')) }}" alt="{{ theme_option('site_title') }}" width="155" />
                            </a>
                        </div>
                    @endif
                </div>
